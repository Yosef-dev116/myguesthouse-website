...
export function Footer() {
  return (
    <footer className="border-t border-hairline bg-charcoal pt-24 pb-10 md:pt-28">
      <Container>
        <InViewGroup className="grid grid-cols-1 gap-10 md:grid-cols-3 md:gap-12">
          <InViewItem>
            <Logo />
          ...
          <InViewItem className="flex flex-col gap-4 border-t border-hairline pt-8 sm:flex-row sm:items-center sm:justify-between md:col-span-3">
